...
(https://github.com/Oascent1/seccrypt/releases/tag/SecureCrypt)
...
1️⃣Download the SecureCrypt_v2.0_Windows.zip file from the Releases page and extract it.

2️⃣Open PowerShell in the extracted folder.

3️⃣Run the command:
[Get-FileHash -Path .\SecureCryptPro.exe -Algorithm SHA256]

4️⃣Open the SHA256SUMS.txt file provided and verify that the hash output by the command matches the hash in the file exactly.
